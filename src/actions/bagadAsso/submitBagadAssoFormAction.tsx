...
export const submitBagadAssoFormAction = createServerFn({ method: "POST" })
    .validator((data: BagadAssoFormData) => data)
    .handler(
        withServerAction(
            ...
            async ({ data }): Promise<FormState> => {
                ...
                if (!result.success) {
                    ...
                    const fieldErrors: Partial<
                        Record<keyof BagadAssoFormData, string[]>
                    > = {}
                    ...
                    prisma.bagadAssoTicket.create({
                        data: {
                            ...
                            estimatedParticipants:
                                validatedData.eventParticipants,
                ...
                await sendEmail({
                    ...
                    html: await render(
                        <NewBagadAssoTicket
                            data={{
                                ...ticketRecord,
                                eventAddr: locationDisplayName(
                                    ticketRecord.eventAddr
                                )
                            }}
                        />
                    )
