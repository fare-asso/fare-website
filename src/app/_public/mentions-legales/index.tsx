...
export const Route = createFileRoute("/_public/mentions-legales/")({
    head: () => ({ meta: [{ title: pageTitle("Mentions Légales") }] }),
        ...
        <div className="flex w-full flex-col items-center justify-start">
            ...
            <div className="mb-10 flex h-full w-full flex-col items-start md:w-3/5 [&_li]:list-disc [&>h2]:mt-6 [&>h2]:mb-2 [&>h2]:text-xl [&>h2]:font-bold [&>h3]:mt-4 [&>h3]:mb-1 [&>h3]:text-lg [&>h3]:font-bold [&>p]:ml-8 [&>ul]:my-2 [&>ul]:ml-16">
                ...
                <p className="mb-1">
                    ...
                    janvier 1978). Les termes « données à caractère personnel »,
                    « personne concernée », « sous-traitant » et « données
                    sensibles » ont le sens défini par le Règlement Général sur
                ...
                <ul>
                    <li>
                        <b>Propriétaire :</b> FÉDÉRATION DES ASSOCIATIONS DE
                        HAUTE-BRETAGNE - 6 Cours des Alliés 35000 Rennes.
                    </li>
                    <li>
                ...
                <p>
                    Le site utilise la technologie JavaScript & HTML. Le site
                ...
                <p>
                    ...
                    confiance dans l'Économie Numérique, la Loi Informatique et
                ...
                <ul>
                    ...
                    <li>
                        ...
                        périmées, ou dont la collecte, l'utilisation, la
                ...
                <p>
                    Si nous prenions connaissance d'une brèche de la sécurité,
                    nous avertirions les utilisateurs concernés afin qu'ils
                ...
                <h2>
                    10. Liens hypertextes « cookies » et balises (« tags »)
                    internet:
                </h2>
                <p>
