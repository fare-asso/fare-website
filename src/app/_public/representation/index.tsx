...
export const Route = createFileRoute("/_public/representation/")({
    head: () => ({ meta: [{ title: pageTitle("Représentation") }] }),
            ...
            <div className="flex w-full max-w-5xl flex-col items-center justify-center gap-12 md:flex-row md:gap-20">
                ...
                >
                    <div className="flex flex-wrap items-center justify-center gap-3">
                        <Image
                            src="/elues/logo-Bouge-Ton-Crous.png"
                            alt="Logo Bouge Ton Crous"
                            className="h-16 w-16 object-contain"
                        />
                        <Image
                            src="/Logo_Crous_vectorisé.png"
                            alt="Logo les Crous"
                            className="h-16 w-16 object-contain"
                        />
                        <Image
                            src="/univ/UNIRENNES_LOGOnoir_centre_RVB.png"
                            alt="Logo Université de Rennes"
                            className="h-16 w-16 object-contain"
                        />
                        <Image
                            src="/univ/Logo_univ-rennes2-2016.png"
