...
export const Route = createFileRoute("/_public/projets/bouge-ta-prison/")({
    head: () => ({ meta: [{ title: pageTitle("Bouge ta Prison") }] }),
    component: BougeTaPrison
})

function BougeTaPrison() {
    return (
