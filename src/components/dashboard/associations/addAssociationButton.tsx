            ...
            <DialogContent className="h-[90%] max-h-[90%] sm:max-w-[60%] lg:max-w-[40%]">
                ...
                <form onSubmit={handleSubmit} id="addAssociationForm" className="space-y-3 overflow-y-auto p-2">
                    ...
                    <div>
                        ...
                        <DatePicker name="birthdate" enableMonthYearDropdown fromYear={1950} />
                    </div>
                ...
                <DialogFooter>
                    <Button type="submit" form="addAssociationForm" disabled={isLoading}>{isLoading ? <LoadingRing/> : null} Ajouter</Button>
                </DialogFooter>
            </DialogContent>
            </Dialog>
    )
