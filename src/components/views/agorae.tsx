...
import food from "@/assets/AGORAe/food.jpg"
import logoAgoraE from "@/assets/AGORAe/logo_AgoraE.png"
import recettesParMois from "@/assets/AGORAe/recettes_par_mois.png"
import salle from "@/assets/AGORAe/salle.jpg"
import tableauRAV from "@/assets/AGORAe/tableau_rav.png"

const rapportActiviteUrl = "/documents/Rapport_activite_AGORAe_2025-2026.pdf"

export default function Agorae({ children }: { children?: React.ReactNode }) {
    return (
        <div className="flex w-full flex-col items-center justify-start px-4 md:px-8 lg:px-16">
            ...
            <div className="mb-20 flex w-full max-w-4xl flex-col items-center space-y-12">
                ...
                <div className="flex flex-col space-y-3 space-x-0 md:flex-row md:space-y-0 md:space-x-2 [&>img]:w-full [&>img]:rounded-xl [&>img]:object-cover md:[&>img]:w-1/2">
                    <img src={salle.src} alt="Cantine de l'AGORAé" />
                    <img src={food.src} alt="Nourriture proposée à l'AGORAé" />
                </div>
